...
* Test Accuracy: ~86%
- Key Insight: The model achieves very low false negatives, ensuring critical pneumonia cases are rarely missed — an important factor in medical applications.
